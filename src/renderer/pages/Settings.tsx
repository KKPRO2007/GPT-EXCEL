        ...
        <main style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: 16, color: 'var(--text)' }}>Appearance</h2>
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: 16, color: 'var(--text)' }}>AI Configuration</h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div className="input-wrap">
                  <label className="input-label">OpenAI API Key</label>
                  <input type="password" className="input" placeholder="sk-..." value="" onChange={() => {}} />
                  <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', marginTop: 4 }}>Your API key is stored locally and never shared</div>
                </div>
                <div className="input-wrap">
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: 16, color: 'var(--text)' }}>Export Preferences</h2>
              <div className="input-wrap">
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: 8, color: 'var(--text)' }}>About GPT-EXCEL</h2>
